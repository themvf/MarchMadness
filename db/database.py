...
Adapted from PredictionMarkets pattern — uses psycopg2 with
a connection wrapper for consistent API. All queries use %s
placeholders (native PostgreSQL).
"""
...
class DatabaseManager:
    def __init__(self, database_url: str) -> None:
        if not database_url:
            raise ValueError("DATABASE_URL is required for Neon PostgreSQL")
